...
int LDR = A0;  // PIN analógico A0 para la foto resistencia (LDR)

//#include "secrets.h"

//Conexión a Wifi
//Nombre de la red Wifi
const char ssid[] = "Angelica Maria's Galaxy S20 FE";
//Contraseña de la red Wifi
const char pass[] = "12345678";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "am.rodriguez12"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "am.rodriguez12";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "201317942";
...
void loop()
{
  ...
  // Se haya el porcentaje de intensidad luminica
  int percentage = l * 100/lum_max;
  ...
  if ( !isnan(h) && !isnan(t) && !isnan(percentage)) {
